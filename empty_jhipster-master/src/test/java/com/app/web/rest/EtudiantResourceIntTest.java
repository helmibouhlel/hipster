...
public class EtudiantResourceIntTest {
    ...
    private static final String DEFAULT_PRESNOM = "AAAAA";
    private static final String UPDATED_PRESNOM = "BBBBB";
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(etudiantResource, "etudiantMapper", etudiantMapper);
    ...
    public void initTest() {
        ...
        etudiant.setPresnom(DEFAULT_PRESNOM);
        etudiant.setAge(DEFAULT_AGE);
    }
    ...
    public void createEtudiant() throws Exception {
        ...
        assertThat(testEtudiant.getPresnom()).isEqualTo(DEFAULT_PRESNOM);
    ...
    public void getAllEtudiants() throws Exception {
        ...
        restEtudiantMockMvc.perform(get("/api/etudiants?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].presnom").value(hasItem(DEFAULT_PRESNOM.toString())))
    ...
    public void getEtudiant() throws Exception {
        ...
        restEtudiantMockMvc.perform(get("/api/etudiants/{id}", etudiant.getId()))
            ...
            .andExpect(jsonPath("$.presnom").value(DEFAULT_PRESNOM.toString()))
    ...
    public void updateEtudiant() throws Exception {
        ...
        // Update the etudiant
        etudiant.setNom(UPDATED_NOM);
        etudiant.setPresnom(UPDATED_PRESNOM);
        etudiant.setAge(UPDATED_AGE);
        EtudiantDTO etudiantDTO = etudiantMapper.etudiantToEtudiantDTO(etudiant);
        ...
        assertThat(testEtudiant.getPresnom()).isEqualTo(UPDATED_PRESNOM);
